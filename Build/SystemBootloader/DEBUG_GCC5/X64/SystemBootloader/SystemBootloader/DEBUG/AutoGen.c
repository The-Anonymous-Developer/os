...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x12345678, 0x90ab, 0xcdef, {0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x12345678, 0x90ab, 0xcdef, {0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SystemBootloader";
...
#define _PCD_VALUE_PcdStackCookieExceptionVector  0x42U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdStackCookieExceptionVector = _PCD_VALUE_PcdStackCookieExceptionVector;
...
const UINT32 _gUefiDriverRevision = 0x0002001EU;
